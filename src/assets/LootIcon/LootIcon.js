  	...
  	return (
		...
		>
            ...
            <g>
                ...
                <g id="Group_17654_2_">
                    <path id="Path_7644_1_" className="lootIcon1" d="M16.9,11.8c0,0-3-2.8-4.3-3.3l2.7,23.4l0.1-0.8L16.9,11.8z"/>
                    ...
                    <path id="Path_7645_1_" className="lootIcon2" d="M21.9,9.1l-6.5,22.8l1.3-20.2L21.9,9.1z"/>
                    <path id="Path_7646_1_" className="lootIcon3" d="M14.4,12.7c-0.6-0.7-1.8-4.3-1.8-4.3l-0.2,5.9C12.4,14.4,14.3,13.4,14.4,12.7z"/>
                    <linearGradient id="Path_7647_3_" gradientUnits="userSpaceOnUse" x1="8.2451" y1="22.3364" x2="15.3478" y2="22.3364">
                        <stop  offset="0" style={{stopColor:"#F0F0F5"}}/>
                        <stop  offset="1" style={{stopColor:"#FFFFFF"}}/>
                    </linearGradient>
                    <path id="Path_7647_1_" className="lootIcon4" d="M14.4,12.7l1,19.2L8.2,15.5L14.4,12.7z"/>
                </g>
            </g>
        </svg>
	);
