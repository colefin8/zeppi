...
function CloudSpan(props) {
  	return (
		...
		>
			...
			<g className="CloudSpanPaths">
				{/* Back row left side */}
				<path id="LeftBack" className="cloudRow0" filter="url(#cloudFilter4)" d="M56.7,84.3c-3.9,0-7.8,0.3-11.5,0.8c0-0.3,0-0.6,0-0.8c0-26.9-18.9-49.4-44.1-54.9v77.4
					c0,0,0,0,0,0l0,115.5c14.4,13.9,34,22.4,55.7,22.4c44.3,0,80.2-35.9,80.2-80.2C136.9,120.2,101,84.3,56.7,84.3z"/>
				<path id="LeftFront" className="cloudRow1" d="M57.6,87.2c-3.9,0-7.8,0.3-11.5,0.8c0-0.3,0-0.6,0-0.8c0-27.5-19.8-50.4-45.9-55.3
					l0,79.5c0,0,0,0,0,0L0,223.3c14.6,15,35,24.4,57.6,24.4c44.3,0,80.2-35.9,80.2-80.2C137.8,123.1,101.9,87.2,57.6,87.2z"/>
				{/* Back Row Right Side COLORS CORRECT*/}
				<path id="RightBack" className="cloudRow0" filter="url(#cloudFilter4)" d="M1920,160.4L1920,0c-0.7,0-1.4,0-2.1,0c-39.2,0-71.8,28.1-78.8,65.3
				...
				<path id="RightFront" className="cloudRow1" d="M1920,162.4l0-160.4c0,0-0.1,0-0.1,0c-39.2,0-71.8,28.1-78.8,65.3
					c-3.3-0.6-6.6-0.9-10.1-0.9c-20.8,0-38.9,11.3-48.7,28.1c-10.3-13.6-26.5-22.3-44.9-22.3c-31.1,0-56.2,25.2-56.2,56.2
					c0,31.1,25.2,56.2,56.2,56.2c20.8,0,38.9-11.3,48.7-28.1c10.3,13.6,26.5,22.3,44.9,22.3c20.5,0,38.5-11,48.3-27.5
					c11.9,7,25.8,11,40.6,11C1919.9,162.4,1920,162.4,1920,162.4z"/>
				{/* Third Row Middle COLORS CORRECT*/}
				<path id="MiddleBack" className="cloudRow0" filter="url(#cloudFilter4)" d="M1207.2,209.3c0-51.9-42.1-94-94-94c-9.1,0-18,1.3-26.3,3.7
				...
				<path id="MiddleFront" className="cloudRow2" d="M1209.1,211.2c0-51.9-42.1-94-94-94c-9.1,0-18,1.3-26.3,3.7
					c-14.4-32-46.5-54.2-83.8-54.2c-15.3,0-29.7,3.7-42.3,10.3c-10.8-13.1-27.2-21.5-45.5-21.5c-32.5,0-58.9,26.3-58.9,58.8
				...
				{/* Third Row Left Set COLORS CORRECT*/}
				<path id="LeftBack" className="cloudRow0" filter="url(#cloudFilter)" d="M586.7,207.4c-9,0-17.6,1.8-25.4,5.1c-11.3-44.4-51.6-77.3-99.5-77.3
				...
				<path id="LeftFront" className="cloudRow2" d="M588.6,209.3c-9,0-17.6,1.8-25.4,5.1c-11.3-44.4-51.6-77.3-99.5-77.3
				...
				{/* Third Row Right Set */}
				<path id="RightBack" className="cloudRow0" filter="url(#cloudFilter)" d="M1919.7,102.5c-9.3-4.5-19.7-7-30.8-7c-30.7,0-56.8,19.5-66.6,46.8
				...
				<path id="RightFront" className="cloudRow2" d="M1920,232.6l-0.3-19.7l-0.1-39.7l-0.4-0.1l-0.9-70c-8.5-3.6-17.8-5.6-27.5-5.6
				...
				{/* Second Row Set CORRECT COLORS*/}
				<path id="Back" className="cloudRow3" filter="url(#cloudFilter)" d="M1673.1,249.5c9.2-11.8,14.7-26.5,14.7-42.6c0-38.3-31-69.3-69.3-69.3c-24.2,0-45.5,12.4-57.9,31.2
				...
				<path id="Front" className="cloudRow0" d="M1675.1,251.4c9.2-11.8,14.7-26.5,14.7-42.6c0-38.3-31-69.3-69.3-69.3
				...
				{/* First Row Set CORRECT COLORS*/}
				<path id="Back" className="cloudRow0" filter="url(#cloudFilter)" d="M1845,154.5c-31.7,0-59.5,16.8-74.9,42c-7.1-3.9-15.3-6.1-24-6.1c-27.9,0-50.5,22.6-50.5,50.5
				...
				<path id="Front" className="cloudRow4" d="M1842.1,158.6c-31.7,0-59.5,16.8-74.9,42c-7.1-3.9-15.3-6.1-24-6.1
